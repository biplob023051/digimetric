                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-group flare">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control"  name="data[TestQuestion][question]" id="title" type="text" value="<?php echo!empty($resultset['TestQuestion']['question']) ? $resultset['TestQuestion']['question'] : ""; ?>"/>
                                    </div>
                                </div>
                                <?php
                                $no_ans = count($resultset['TestQuestionAnswer']);
                                ?>
                                <?php
                                foreach ($resultset['TestQuestionAnswer'] as $key => $value) { ?>
                                    
                                    <div class="form-group flare">

                                        <label class="control-label col-md-4"> Option - <?php echo $key+1; ?></label>
                                        <div class="col-md-8">
                                            <input type="checkbox" name="data[TestQuestionAnswer][<?php echo $key; ?>][is_correct]" <?php if(isset($value['is_correct']) && $value['is_correct']==1){ echo "checked"; } ?>/>Is answer?
                                            <input class="form-control"  name="data[TestQuestionAnswer][<?php echo $key; ?>][answer_text]" id="title" type="text" value="<?php echo $value['answer_text'] ?>"/>
                                            <input class="form-control"  name="data[TestQuestionAnswer][<?php echo $key; ?>][id]" id="title" type="hidden" value="<?php echo $value['id'] ?>"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group flare">
                                    ...
                                    <label class="control-label col-md-4"> <a href='javascript:void(0)' onclick='clone_option()'>+Add more options</a></label>
                                    <div id='option_div' class="col-md-8">
...
<script>
    ...
    function clone_option() {

        $("#option_div").append('<input type="checkbox" name="corrects[]"/>Is answer?<input type="text" value="" name="new_options[]" class="form-control"/>');
