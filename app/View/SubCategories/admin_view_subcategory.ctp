...
<div class="row">
    <div class="col-md-12"> 
        ...
        <h3 class="page-title"> <?php // echo $form_data["display_text"];  ?> category </h3>
        <ul class="page-breadcrumb breadcrumb">
            <li> <i class="fa fa-home"></i> <a href="<?php echo ADMIN_BASEURL; ?>admins/dashboard"> Home </a> <i class="fa fa-angle-right"></i> </li>

            <li> <a href="javascript:void(0);"> <?php // echo $form_data["display_text"];  ?> category </a> </li>
        </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group flare">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <img height="150" width="150" src="<?php echo $this->webroot; ?>uploads/categories/<?php echo $resultset['image']; ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <a href="<?php echo ADMIN_BASEURL ?>sub_categories/manage_category"  class="btn theme-btn grey pull-left margd">Cancel</a>
                            </div>
                        </div>
                        <!--</form>-->
                    </div>
