...
<div class="row">
    <div class="col-md-12"> 
        ...
        <ul class="page-breadcrumb breadcrumb">
            <li class="btn-group"> <a href="<?php echo ADMIN_BASEURL ?>sub_categories/add_subcategory" class="btn blue dropdown-toggle"> <span> Add subfield </span> </a> </li>
            <li> <i class="fa fa-home"></i> <a href="<?php echo ADMIN_BASEURL; ?>admins/dashboard"> Home </a> <i class="fa fa-angle-right"></i> </li>
            <li> <a href="javascript:void(0);"> Manage subfield </a> </li>
        </ul>
    ...
    <div class="col-md-12">
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="active"> <a data-toggle="tab" href="#tab_1_5"> Manage subfield </a> </li>
            </ul>
...
//                                      
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($v["SubCategory"]["status"] == 1) { ?>
                                                    <span class="label label-sm label-success"> <a href="<?php echo ADMIN_BASEURL; ?>sub_categories/enable_disable_subcategory/<?php echo $v["SubCategory"]["id"]; ?>/0" onclick="return enable_disable_subcategory('disable');">Inactivate</a> </span>
                                                <?php } else { ?>
                                                    <span class="label label-sm label-success"> 
                                                        <a href="<?php echo ADMIN_BASEURL; ?>sub_categories/enable_disable_subcategory/<?php echo $v["SubCategory"]["id"]; ?>/1" onclick="return enable_disable_subcategory('enable');">
                                                            Activate
                                                        </a>
                                                    </span>
                                                <?php } ?>
                                            ...
                                            <td>
                                                ...
                                                <a class="" href="<?php echo ADMIN_BASEURL; ?>sub_categories/view_subcategory/<?php echo $v["SubCategory"]["id"]; ?>"> <i class="fa fa-search fonta"></i> </a> 
                                                <a class="can_delete" href=" <?php echo ADMIN_BASEURL; ?>sub_categories/delete_subcategory/<?php echo $v["SubCategory"]["id"]; ?>"  onclick="return delete_fun();"><i class="can_delete fa fa-times fonta"></i></a> 
                                                <a class="" href="<?php echo ADMIN_BASEURL; ?>sub_categories/edit_subcategory/<?php echo $v["SubCategory"]["id"]; ?>"><i class="fa fa-edit fonta"></i></a></td>
                                        </tr>
                                        <?php
                                    }
                                } else {
...
<script>
    function delete_fun() {
        if (confirm("Are you sure you want to delete the subfield?")) {
            return true;
        }
        else {
            return false;
    ...
    function enable_disable_subcategory(item) {
        if (confirm("Are you sure you want to " + item + " the subfield?")) {
            return true;
        }
        else {
            return false;
