                                    ...
                                    <div class="container">
                                        <div class="descrive">
                                            <div class="col-lg-12 zeropadd">
                                                <h1>
                                                  <img style="height: 50px;width: 50px;" src="<?php echo BASEURL ?>/uploads/test_logo/<?php echo $value['Test']['logo']; ?>" />
                                                  <?php echo $value['Test']['title']; ?>
                                                </h1>
                                            </div>
                                            ...
                                            <div class="col-lg-6 descrivein ">
                                                ...
                                                <p>Duration : 
                                                    ...
                                                    <?php echo !empty($value['Test']['duration_mins']) ? $value['Test']['duration_mins']." Min(s)" :''; ?>
                                                    <?php echo !empty($value['Test']['duration_secs']) ? $value['Test']['duration_secs']." Sec(s)" :''; ?>
                                                </p>

                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="col-lg-12  ">
                                                <h4><strong>Description:</strong> <?php echo $value['Test']['description']; ?></h4>
                                            </div>
                                            <br />
                                            <div class="col-lg-12 text-center"><button class="start " value="Start Test" onclick="window.location.href='<?php echo BASEURL;?>/job_candidates/start_test/?job_id=<?php  echo $tests[0]["JobTest"]["job_id"]?>&test_id=<?php echo $tests[0]["JobTest"]["test_id"]?>&version=<?php echo $test_versions?>'">Start Test</button>
                                            </div>
