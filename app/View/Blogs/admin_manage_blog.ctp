...
<div class="row">
    <div class="col-md-12"> 
        ...
        <ul class="page-breadcrumb breadcrumb">
            <li class="btn-group"> <a href="<?php echo ADMIN_BASEURL ?>blogs/add_blog" class="btn blue dropdown-toggle"> <span> Add blog </span> </a> </li>
    ...
    <div class="col-md-12">
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="active"> <a data-toggle="tab" href="#tab_1_5"> Manage Blogs </a> </li>
            </ul>
...
<!--                    <div class="row search-form-default">
                        <div class="col-md-12">
                            <form class="form-inline" action="<?php echo ADMIN_BASEURL; ?>blogs/add_blog/" id="search">
...
//                                                debug($value);
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $v["Blog"]["title"]; ?></td>
                                            <td><?php echo $v["Blog"]["description"]; ?></td>
                                            <td><?php echo $v["Blog"]["long_desc"]; ?></td>
                                            <td><?php echo $v["Blog"]["published_on"]; ?></td>
                                            <td><?php echo $v["Blog"]["publish_by"]; ?></td>
                                            <td><?php echo !empty($all_tags) ? implode(",", $all_tags) :'No tags';    ?></td>
                                            <!--<td><?php echo $v["Blog"]["status"]; ?></td>-->
                                            <td>
                                                <?php if ($v["Blog"]["status"] == 1) { ?>
                                                    <span class="label label-sm label-success"> <a href="<?php echo ADMIN_BASEURL; ?>blogs/enable_disable_blog/<?php echo $v["Blog"]["id"]; ?>/0" onclick="return enable_disable_blog('disable');">Inactivate</a> </span>
                                                <?php } else { ?>
                                                    <span class="label label-sm label-success"> 
                                                        <a href="<?php echo ADMIN_BASEURL; ?>blogs/enable_disable_blog/<?php echo $v["Blog"]["id"]; ?>/1" onclick="return enable_disable_blog('enable');">
                                                            Activate
                                                        </a>
                                                    </span>
                                                <?php } ?>
                                            ...
                                            <td>
                                                ...
                                                <a class="" href="<?php echo ADMIN_BASEURL; ?>blogs/view_blog/<?php echo $v["Blog"]["id"]; ?>"> <i class="fa fa-search fonta"></i> </a> 
                                                <a class="can_delete" href=" <?php echo ADMIN_BASEURL; ?>blogs/delete_blog/<?php echo $v["Blog"]["id"]; ?>"  onclick="return delete_fun();"><i class="can_delete fa fa-times fonta"></i></a> 
                                                <a class="" href="<?php echo ADMIN_BASEURL; ?>blogs/edit_blog/<?php echo $v["Blog"]["id"]; ?>"><i class="fa fa-edit fonta"></i></a></td>
                                        </tr>
                                        <?php
                                    }
                                } else {
...
<script>
    ...
    function enable_disable_blog(item) {
        if (confirm("Are you sure you want to " + item + " the blog?")) {
            return true;
        }
        else {
            return false;
