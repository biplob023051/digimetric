...
<div class="row">
    <div class="col-md-12"> 
        ...
        <h3 class="page-title"> field </h3>
        <ul class="page-breadcrumb breadcrumb">
            <li class="btn-group"> <a href="<?php echo ADMIN_BASEURL ?>categories/add_category" class="btn blue dropdown-toggle"> <span> Add field </span> </a> </li>
            <li> <i class="fa fa-home"></i> <a href="<?php echo ADMIN_BASEURL; ?>admins/dashboard"> Home </a> <i class="fa fa-angle-right"></i> </li>
            <li> <a href="javascript:void(0);"> Manage field </a> </li>
        </ul>
    ...
    <div class="col-md-12">
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="active"> <a data-toggle="tab" href="#tab_1_5"> Manage field </a> </li>
            </ul>
...
//                                      
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($v["Category"]["status"] == 1) { ?>
                                                    <span class="label label-sm label-success"> <a href="<?php echo ADMIN_BASEURL; ?>categories/enable_disable_category/<?php echo $v["Category"]["id"]; ?>/0" onclick="return enable_disable_category('disable');">Inactivate</a> </span>
                                                <?php } else { ?>
                                                    <span class="label label-sm label-success"> 
                                                        <a href="<?php echo ADMIN_BASEURL; ?>categories/enable_disable_category/<?php echo $v["Category"]["id"]; ?>/1" onclick="return enable_disable_category('enable');">
                                                            Activate
                                                        </a>
                                                    </span>
                                                <?php } ?>
                                            ...
                                            <td>
                                                ...
                                                <a class="" href="<?php echo ADMIN_BASEURL; ?>categories/view_category/<?php echo $v["Category"]["id"]; ?>"> <i class="fa fa-search fonta"></i> </a> 
                                                <a class="can_delete" href=" <?php echo ADMIN_BASEURL; ?>categories/delete_category/<?php echo $v["Category"]["id"]; ?>"  onclick="return delete_fun();"><i class="can_delete fa fa-times fonta"></i></a> 
                                                <a class="" href="<?php echo ADMIN_BASEURL; ?>categories/edit_category/<?php echo $v["Category"]["id"]; ?>"><i class="fa fa-edit fonta"></i></a></td>
                                        </tr>
                                        <?php
                                    }
                                } else {
...
<script>
    ...
    function enable_disable_category(item) {
        if (confirm("Are you sure you want to " + item + " the field?")) {
            return true;
        }
        else {
            return false;
